...
///////////////////////// CRUD WEB  /////////////////////////
  ...
  public function tampil_jadwal_update($id_jadwal){
    $this->db->select('tbjadwal.id_jadwal as id_jadwal, tbjadwal.nip as nip, tbjadwal.waktu as waktu, tbkelas.nama_kelas as nama_kelas, tbmatkul.nama_matkul as nama_matkul, tbmatkul.id_matkul as id_matkul');
    $this->db->order_by('waktu', 'ASC');
    $this->db->from('tbjadwal');
    $this->db->join('tbkelas', 'tbkelas.id_kelas = tbjadwal.id_kelas');
    $this->db->join('tbdosen', 'tbdosen.nip = tbjadwal.nip');
